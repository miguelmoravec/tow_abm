...
while (a<nrow(data2)) {
  ...
  } else if (as.integer(substr(date, 6, 7)) > as.integer(substr(date_prev, 6, 7)) + 1) {
      data2$cat[a] = 1
...
write.csv(up, paste("3upstreaming_datetest", name, sep=""), row.names=FALSE)
write.csv(down, paste("3downstreaming_datetest", name, sep=""), row.names=FALSE)
```
